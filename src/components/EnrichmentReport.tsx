        ...
        <dl className="enrichment-card__totals">
          {totals.map(({ label, value, currency }) => (
            <div key={label} className="enrichment-card__total-row">
              <dt className="enrichment-card__total-label">{label}</dt>
    ...
    <div className="enrichment-report">
      <div className="enrichment-report__header">
        ...
        <div>
          ...
          <p className="enrichment-report__subtitle" dangerouslySetInnerHTML={{ 
            __html: t('app.result.subtitle', { count: summary.totalRowsAdded, activeTables: activeTablesCount }) 
          }} />
        </div>
      </div>
