...
1. Upload all relevant broker files. At the moment, XTB, Trade Republic, Trading 212, DEGIRO, and E*TRADE are supported (some values are still not imported, so check the limitations on the main page).
