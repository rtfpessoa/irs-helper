...
1. Upload all relevant PDF reports from your brokers. At the moment, XTB, Trade Republic, Trading 212, and ActivoBank are supported (some values are still not imported, so check the limitations on the main page).
